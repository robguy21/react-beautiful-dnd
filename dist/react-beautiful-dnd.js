(function (global, factory) {
  ...
  */
  ...
  function getClosestToCursor(_ref) {
    var currentSelection = _ref.currentSelection,
        candidates = _ref.candidates;
    var sorted = candidates.map(function (candidate) {
      var box = candidate.page.borderBox;
      var isWithinX = isWithin(box.left, box.right)(currentSelection.x);
      var isWithinY = isWithin(box.top, box.bottom)(currentSelection.y);
      ...
      if (isWithinX) {
        return result(closest(patch('y', currentSelection.y), [patch('y', box.top), patch('y', box.bottom)]));
      }

      if (isWithinY) {
        return result(closest(patch('x', currentSelection.x), [patch('x', box.left), patch('x', box.right)]));
      }

      return result(closest(currentSelection, [{
        x: box.left,
        y: box.top
      }, {
        x: box.right,
  ...
  function getDroppableOver$1(_ref3) {
    var pageBorderBox = _ref3.pageBorderBox,
        draggable = _ref3.draggable,
        droppables = _ref3.droppables,
        currentSelection = _ref3.currentSelection,
        calculateDroppableUsingPointerPosition = _ref3.calculateDroppableUsingPointerPosition;
    var candidates = toDroppableList(droppables).filter(function (item) {
      ...
      var hasOverlap = getHasOverlap(pageBorderBox, active);
  ...
  var getDragImpact = (function (_ref) {
    var pageOffset = _ref.pageOffset,
        ...
        calculateDroppableUsingPointerPosition = _ref.calculateDroppableUsingPointerPosition;
    ...
    var destinationId = getDroppableOver$1({
      ...
      draggable: draggable,
      droppables: droppables,
      calculateDroppableUsingPointerPosition: calculateDroppableUsingPointerPosition
    });
  ...
  var update = (function (_ref) {
    ...
    var newImpact = forcedImpact || getDragImpact({
      ...
      calculateDroppableUsingPointerPosition: state.critical.draggable.dropTargetCalculationMode === 'pointer'
    });
  ...
  var publishWhileDraggingInVirtual = (function (_ref) {
    ...
    var impact = getDragImpact({
      ...
      afterCritical: afterCritical,
      currentSelection: state.current.page.selection,
      calculateDroppableUsingPointerPosition: draggable.descriptor.dropTargetCalculationMode === 'pointer'
    });
